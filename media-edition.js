(function(){
 ...
 const tools=[['kickoff','킥오프 시간 변환','현지 경기 시간을 한국시간으로',clock],['boot-size','축구화 사이즈','발 길이로 사이즈 표 확인',size],['best11','나만의 베스트11','포메이션을 고르고 라인업 저장',pitch],['points-sim','승점 시뮬레이터','남은 경기 결과에 따른 승점 계산',points]];
